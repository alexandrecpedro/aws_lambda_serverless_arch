...
| Maps | <ul><li>Unordered collection of Key-Value pairs</li> <li>Ideal for storing JSON documents</li></ul> | <ul><li>{ name: "John", age: 22, address: { city: "Stamford", state: "Connecticut" } }</li></ul> |
